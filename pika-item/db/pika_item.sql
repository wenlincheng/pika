...
CREATE TABLE `category_attr` (
  ...
  `name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '属性名称',
  `attr_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '属性类型',
  ...
  `vals` varchar(2048) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '属性值',
  `vals_str` varchar(2048) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'string拼接字段',
...
CREATE TABLE `category_banner` (
  ...
  `link_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '关联类型',
  `item_id` bigint(20) DEFAULT NULL COMMENT '关联商品的ID',
  `shop_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '店铺code',
  `file_url` varchar(2000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '轮播图片地址',
...
CREATE TABLE `category` (
  ...
  `name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目名称',
  `depth` int(11) DEFAULT NULL COMMENT '层级',
  `parent_cate_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父类目编码',
  `path` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目路径，,分隔。例如：0,1,5,6',
  `description` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目描述',
  `status` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目状态',
  `code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '编码',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_user_id` bigint(20) DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `front_category` (
  ...
  `parent_cate_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父类目编码',
  `depth` int(11) DEFAULT NULL COMMENT '层级',
  `path` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目路径，逗号分隔。例如：0,1,5,6',
  `logo_url` varchar(512) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目Logo URL',
  `status` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目状态',
  `banner_urls` varchar(512) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'banner图片地址',
  `code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '编码',
...
CREATE TABLE `inventory_sku_composition` (
  `id` bigint(20) NOT NULL COMMENT 'ID',
  `bind_sku_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品编码',
  `bind_sku_name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品名称',
...
CREATE TABLE `inventory_sku` (
  `id` bigint(20) NOT NULL COMMENT 'ID',
  `name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'sku名称',
  `spread_name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '简称、俗称',
  `en_name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '英文名称',
  ...
  `sku_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'SKU类型',
  `brand_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌编码',
  ...
  `main_pic_url` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '主图url',
  `category_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '后台类目编码',
  `product_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品编码',
  `sku_attr_vals` varchar(2048) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'SKU属性',
  `data_status` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品状态',
...
CREATE TABLE `item_series` (
  `id` bigint(20) NOT NULL COMMENT 'ID',
  `code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '系列编码',
  `name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '系列名称',
  `remark` text COLLATE utf8mb4_bin COMMENT '备注',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_user_id` bigint(20) DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `item` (
  ...
  `name` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品名称',
  `simple_name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品简称',
  `source` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品来源',
  `product_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品编码',
  `shop_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '店铺CODE',
  `category_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目CODE',
  `brand_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌CODE',
  `spec` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '规格型号',
  `sale_attr_vals` varchar(4094) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '销售属性',
  `normal_attr_vals` varchar(4094) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品其他属性',
  `main_pic_url` varchar(512) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '主图url',
  `pics_url` varchar(1024) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品图片集url',
  `item_status` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '启用状态(数据状态)',
  `sale_status` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品销售状态',
  `audit_status` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品审核状态',
  ...
  `base_unit_id` bigint(20) DEFAULT NULL COMMENT '基础单位ID',
  `inv_unit_id` bigint(20) DEFAULT NULL COMMENT '库存单位ID',
  `unit_convert` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '48,件|4,盒|1,箱',
  `inventory_reduce_setting` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '库存扣减方式',
  `pickup_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '提货方式',
  `description` varchar(256) COLLATE utf8mb4_bin COMMENT '商品描述',
  `detail_html` text COLLATE utf8mb4_bin COMMENT '商品详情',
  `after_sale_services` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '售后服务',
  `tags` text COLLATE utf8mb4_bin COMMENT '标签 用,分隔',
  `is_publish_by_time` tinyint(1) DEFAULT NULL COMMENT '定时发布',
  `publish_time` datetime DEFAULT NULL COMMENT '发布时间',
  `channel_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '渠道编码',
  ...
  `recommend_item_ids` varchar(512) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商品推荐Id集合',
...
CREATE TABLE `product` (
  `id` bigint(20) NOT NULL COMMENT 'ID',
  `name` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品名称',
  `source` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品来源',
  `product_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品来源',
  `sku_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品类型',
  `category_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目CODE',
  `cate_path` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目路径',
  `brand_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '品牌CODE',
  `attr_vals` varchar(4096) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '属性',
  `main_pic_url` varchar(256) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '主产品图片地址',
  `pics_url` varchar(1024) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品图片列表',
  ...
  `unit_convert` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '48,件|4,盒|1,箱',
  `inventory_reduce_setting` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '库存扣减方式',
  `delivery_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '物流方式',
  `purpose` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品用途',
  `description` text COLLATE utf8mb4_bin COMMENT '产品描述',
  `data_status` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品状态',
  `code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '编码',
...
CREATE TABLE `sale_sku` (
  ...
  `inv_sku_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '产品 SKU编码',
  `name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '销售sku名称',
  `simple_name` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '销售sku简称',
  `code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '编码',
  `bar_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '条形码',
  `short_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '内部简码',
  `sku_pic_url` varchar(128) DEFAULT NULL COMMENT 'sku图片url',
  `spec` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '规格型号',
  `sale_attr_vals` varchar(4096) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '销售属性值',
  ...
  `out_id` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '外部编码',
...
CREATE TABLE `shop_category` (
  ...
  `sort_num` int(11) DEFAULT NULL COMMENT '排序',
  `shop_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '店铺CODE',
  `cate_rel_type` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '关联类型',
  `item_id` bigint(20) DEFAULT NULL COMMENT '商品ID',
  `parent_cate_code` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父类目编码',
  `depth` int(11) DEFAULT NULL COMMENT '层级',
  `path` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '类目路径，逗号分隔。例如：0,1,5,6',
